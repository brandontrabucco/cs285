...
from cs285.algorithms.imitate.behavior_cloning import BehaviorCloning as BehaviorCloningAlgorithm
import tensorflow as tf


class BehaviorCloning(Baseline):
    ...
    def build(
        ...
        algorithm = BehaviorCloningAlgorithm(
            policy,
            batch_size=self.batch_size,
            monitor=self.monitor)

        return expert_policy, expert_policy, policy, replay_buffer, algorithm, saver
