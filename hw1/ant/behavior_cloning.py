...
def run_experiment(experiment_id):
    ...
    behavior_cloning_variant["logging_dir"] = "./ant/behavior_cloning/{}".format(experiment_id)
    ...
    behavior_cloning_variant["expert_policy_ckpt"] = "./ant/expert_policy.ckpt"
    ...
    behavior_cloning(behavior_cloning_variant, AntEnv)
