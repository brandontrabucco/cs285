...
def run_experiment(experiment_id):
    ...
    dagger_variant["logging_dir"] = "./half_cheetah/dagger/{}".format(experiment_id)
    dagger_variant["hidden_size"] = 256
    dagger_variant["num_hidden_layers"] = 2
    dagger_variant["exploration_noise_std"] = 0.1
    dagger_variant["expert_policy_ckpt"] = "./half_cheetah/expert_policy.ckpt"
    ...
    dagger(dagger_variant, HalfCheetahEnv)
