...
def run_experiment(experiment_id):
    ...
    behavior_cloning_variant["logging_dir"] = "./walker2d/behavior_cloning/{}".format(experiment_id)
    ...
    behavior_cloning_variant["expert_policy_ckpt"] = "./walker2d/expert_policy.ckpt"
    ...
    behavior_cloning(behavior_cloning_variant, Walker2dEnv)
